...
export const getCollaborationOverview = (params?: {
  year?: number;
  month?: number;
  departmentId?: string;
}) =>
  request<CollaborationOverview>({
    method: "GET",
    url: "/collaboration/overview",
    params,
  });
export const getCollaborationTodos = () =>
  request<CollaborationTodo[]>({ method: "GET", url: "/collaboration/todos" });
export async function getCollaborationReferences() {
  const rows = await request<CollaborationReferences[]>({
    method: "GET",
    url: "/collaboration/references",
  });
...
export const acceptProjectHandover = (id: string, data: { comment?: string }) =>
  request<any>({
    method: "POST",
    url: `/collaboration/handovers/${id}/accept`,
    data,
  });
...
export const uploadHandoverMaterial = (id: string, file: File) => {
  ...
  return request<any>({
    method: "POST",
    url: `/collaboration/handovers/${id}/materials`,
    data,
  });
};
export const saveResponsibility = (data: {
  ...
  request<any>({
    method: "POST",
    url: "/collaboration/responsibilities",
    data,
  });
...
export const recordProjectHours = (id: string, actualHours: number) =>
  request<any>({
    method: "PUT",
    url: `/collaboration/staff/${id}/hours`,
    data: { actualHours },
  });
export const actOnCollaborationTodo = (type: string, id: string, data: any) =>
  request<any>({
    method: "POST",
    url: `/collaboration/todos/${type}/${id}/actions`,
    data,
  });
...
export const reviewTimesheet = (
  ...
  request<any>({
    method: "POST",
    url: `/collaboration/timesheets/${id}/review`,
    data: { decision, comment },
  });
export const lockTimesheetPeriod = (yearMonth: string, reason: string) =>
  request<any>({
    method: "POST",
    url: "/collaboration/timesheet-period-locks",
    data: { yearMonth, reason },
  });
...
export const reviewBudgetChange = (
  ...
  request<any>({
    method: "POST",
    url: `/collaboration/budget-changes/${id}/review`,
    data: { decision, comment },
  });
export async function exportCollaboration(params?: {
  year?: number;
  month?: number;
  departmentId?: string;
}) {
  const response = await http.get("/collaboration/export", {
    params,
    responseType: "blob",
  });
