...
export type ApprovalRuntimeNode = {
  id: string;
  stepNo: number;
  nodeStatus: string;
  approvalMode?: string;
...
export function getOfficeOverview() {
  return request<OfficeOverview>({ method: "GET", url: "/office/overview" });
}
export function getOfficeWorkbench() {
  return request<Workbench>({ method: "GET", url: "/office/workbench" });
}
export function getOfficeReferences() {
  return request<OfficeReferences>({
    method: "GET",
    url: "/office/references",
  });
}
...
export function createApproval(data: {
  ...
  return request<Approval>({ method: "POST", url: "/office/approvals", data });
}
export function processApproval(
  ...
  return request<Approval>({
    method: "POST",
    url: `/office/approvals/${id}/process`,
    data,
  });
}
export function transferApproval(
  id: string,
  data: { targetUserId: string; comment: string; operatorName: string },
) {
  return request<Approval>({
    method: "POST",
    url: `/office/approvals/${id}/transfer`,
    data,
  });
}
export function addSignApproval(
  id: string,
  data: { targetUserId: string; comment: string; operatorName: string },
) {
  return request<Approval>({
    method: "POST",
    url: `/office/approvals/${id}/add-sign`,
    data,
  });
}
export function withdrawApproval(
  id: string,
  data: { comment: string; operatorName: string },
) {
  return request<Approval>({
    method: "POST",
    url: `/office/approvals/${id}/withdraw`,
    data,
  });
}
export function returnApproval(
  ...
  return request<Approval>({
    method: "POST",
    url: `/office/approvals/${id}/return`,
    data,
  });
}
export function resubmitApproval(
  id: string,
  data: { comment: string; applicantName: string },
) {
  return request<Approval>({
    method: "POST",
    url: `/office/approvals/${id}/resubmit`,
    data,
  });
}
export function listExpenses() {
  return request<Expense[]>({ method: "GET", url: "/office/expenses" });
}
...
export function createOutsource(data: {
  ...
  return request<Outsource>({
    method: "POST",
    url: "/office/outsourcing",
    data,
  });
}
export function completeOutsource(
  id: string,
  data: { acceptanceNote: string },
) {
  return request<Outsource>({
    method: "POST",
...
export function listDocuments() {
  return request<DocumentRecord[]>({ method: "GET", url: "/office/documents" });
}
export function searchDocuments(
  ...
  return request<{
    ...
    number: number;
    size: number;
  }>({ method: "GET", url: "/office/documents/search", params });
}
...
export function uploadDocument(data: {
  ...
  form.append("bizType", data.bizType);
...
export function uploadDocuments(data: {
  ...
  return request<DocumentRecord[]>({
    method: "POST",
    url: "/office/documents/batch",
    data: form,
  });
}
export function updateDocumentName(id: string, fileName: string) {
  return request<DocumentRecord>({
    method: "PUT",
    url: `/office/documents/${id}`,
    params: { fileName },
  });
}
export function deleteDocument(id: string) {
  return request<void>({ method: "DELETE", url: `/office/documents/${id}` });
}
export function deleteDocumentsByBiz(bizType: string, bizId: string) {
  return request<void>({
    method: "DELETE",
    url: "/office/documents/by-biz",
...
export async function downloadDocument(item: DocumentRecord) {
  const response = await http.get<Blob>(
    `/office/documents/${item.id}/download`,
    { responseType: "blob" },
  );
...
export async function previewDocument(item: DocumentRecord) {
  const response = await http.get<Blob>(
    `/office/documents/${item.id}/preview`,
    { responseType: "blob" },
  );
...
export function readNotification(id: string) {
  return request<NotificationRecord>({
    method: "POST",
    url: `/office/notifications/${id}/read`,
  });
}
export function refreshNotifications() {
  return request<number>({
    method: "POST",
    url: "/office/notifications/refresh",
  });
}
export function listAudits() {
  return request<AuditRecord[]>({ method: "GET", url: "/office/audits" });
}
