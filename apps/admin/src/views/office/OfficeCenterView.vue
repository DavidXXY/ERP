  ...
  <div class="page-stack">
    ...
    <a-modal v-model:open="approvalCreateOpen" title="发起通用审批" width="680px" :confirm-loading="saving" @ok="handleApprovalCreate">
      <a-form ref="approvalCreateFormRef" :model="approvalCreateForm" :rules="approvalCreateRules" layout="vertical">
        <a-row :gutter="16"><a-col :span="12"><a-form-item label="审批单号" name="code"><a-input v-model:value="approvalCreateForm.code" /></a-form-item></a-col><a-col :span="12"><a-form-item label="审批类型" name="approvalType"><a-select v-model:value="approvalCreateForm.approvalType" :options="approvalTypeOptions" /></a-form-item></a-col></a-row>
    ...
    <a-modal v-model:open="expenseOpen" title="新增费用报销" width="720px" :confirm-loading="saving" @ok="handleExpense">
      <a-form ref="expenseFormRef" :model="expenseForm" :rules="expenseRules" layout="vertical"><a-row :gutter="16"><a-col :span="12"><a-form-item label="报销单号" name="code"><a-input v-model:value="expenseForm.code" /></a-form-item></a-col><a-col :span="12"><a-form-item label="报销人" name="claimantId"><a-select v-model:value="expenseForm.claimantId" :options="userOptions" @change="onClaimantChange" /></a-form-item></a-col><a-col :span="12"><a-form-item label="费用类型" name="expenseType"><a-select v-model:value="expenseForm.expenseType" :options="expenseTypeOptions" /></a-form-item></a-col><a-col :span="12"><a-form-item label="金额" name="amount"><a-input-number v-model:value="expenseForm.amount" :min="0.01" :precision="2" class="full-input" /></a-form-item></a-col><a-col :span="12"><a-form-item label="发生日期" name="expenseDate"><a-input v-model:value="expenseForm.expenseDate" type="date" /></a-form-item></a-col><a-col :span="12"><a-form-item label="绑定项目"><a-select v-model:value="expenseForm.projectId" allow-clear :options="projectOptions" /></a-form-item></a-col><a-col :span="24"><a-form-item label="绑定工单"><a-select v-model:value="expenseForm.workOrderId" allow-clear show-search option-filter-prop="label" :options="workOrderOptions" /></a-form-item></a-col><a-col :span="24"><a-form-item label="费用说明" name="description"><a-textarea v-model:value="expenseForm.description" :rows="3" /></a-form-item></a-col></a-row></a-form>
    </a-modal>

    <a-modal v-model:open="outsourceOpen" title="新增外包服务" width="760px" :confirm-loading="saving" @ok="handleOutsource">
      <a-form ref="outsourceFormRef" :model="outsourceForm" :rules="outsourceRules" layout="vertical"><a-row :gutter="16"><a-col :span="12"><a-form-item label="外包单号" name="code"><a-input v-model:value="outsourceForm.code" /></a-form-item></a-col><a-col :span="12"><a-form-item label="服务商" name="supplierId"><a-select v-model:value="outsourceForm.supplierId" show-search option-filter-prop="label" :options="supplierOptions" /></a-form-item></a-col><a-col :span="12"><a-form-item label="服务类型" name="serviceType"><a-input v-model:value="outsourceForm.serviceType" placeholder="外包检测、外协施工" /></a-form-item></a-col><a-col :span="12"><a-form-item label="金额" name="amount"><a-input-number v-model:value="outsourceForm.amount" :min="0.01" :precision="2" class="full-input" /></a-form-item></a-col><a-col :span="12"><a-form-item label="计划日期" name="plannedDate"><a-input v-model:value="outsourceForm.plannedDate" type="date" /></a-form-item></a-col><a-col :span="12"><a-form-item label="绑定项目"><a-select v-model:value="outsourceForm.projectId" allow-clear :options="projectOptions" /></a-form-item></a-col><a-col :span="24"><a-form-item label="绑定工单"><a-select v-model:value="outsourceForm.workOrderId" allow-clear show-search option-filter-prop="label" :options="workOrderOptions" /></a-form-item></a-col><a-col :span="24"><a-form-item label="服务说明" name="description"><a-textarea v-model:value="outsourceForm.description" :rows="3" /></a-form-item></a-col></a-row></a-form>
    </a-modal>
...
const approvalCreateRules={code:[{required:true}],approvalType:[{required:true}],title:[{required:true}],applicantName:[{required:true}],content:[{required:true}]}; const processRules={decision:[{required:true}],comment:[{required:true}],approverName:[{required:true}]}; const expenseRules={code:[{required:true}],claimantId:[{required:true}],expenseType:[{required:true}],amount:[{required:true}],expenseDate:[{required:true}],description:[{required:true}]}; const outsourceRules={code:[{required:true}],supplierId:[{required:true}],serviceType:[{required:true}],amount:[{required:true}],plannedDate:[{required:true}],description:[{required:true}]}; const outsourceCompleteRules={acceptanceNote:[{required:true}]}; const uploadRules={bizType:[{required:true}],file:[{required:true,message:"请选择文件"}]};
