...
export const loginApi = (username: string, password: string, mfaCode?: string) => request<LoginResponse>({ url: "/auth/login", method: "POST", data: { username, password, mfaCode } });
...
export const bindWechatApi = (code: string, username: string, password: string, mfaCode?: string) => request<LoginResponse>({ url: "/auth/wechat/bind", method: "POST", data: { code, username, password, mfaCode } });
