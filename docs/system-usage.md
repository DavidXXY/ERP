...
供应商可从独立门户注册账号。已有供应商主档必须使用采购邀请生成的 7 天一次性注册码完成绑定；内部人员在“供应商门户账号”中审核账号与自助上传资料，并可停用/恢复账号或重置临时密码。账号审核通过不等于供应商准入通过。只有门户账号已启用、供应商准入已通过、未被冻结且已完成首次改密时，供应商才能对受邀询价报价。
