...
public class CollaborationService {
  ...
  public List<Map<String,Object>> todos() {
    ...
    projects.findByApprovalStatus(ProjectApprovalStatus.PENDING).stream().filter(this::visibleProject).forEach(p->rows.add(todo("PROJECT_APPROVAL",p.getId(),"立项审批待处理 "+p.getCode(),p.getName(),p.getCreatedAt(),"/projects/list",null)));
