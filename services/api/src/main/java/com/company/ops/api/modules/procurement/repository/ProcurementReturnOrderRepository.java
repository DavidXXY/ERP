...
public interface ProcurementReturnOrderRepository extends JpaRepository<ProcurementReturnOrder,UUID>{
  List<ProcurementReturnOrder> findAllByOrderByReturnDateDesc();
  List<ProcurementReturnOrder> findByOrderId(UUID orderId);
}
