...
public final class ApprovalConfigDtos {
  ...
  public record ApprovalConfigResponse(UUID id, String flowCode, String flowName, UUID userId, String userName,
  ...
  public record CreateApprovalConfigRequest(@NotBlank @Size(max = 64) String flowCode,
                                            ...
                                            @NotNull UUID userId, @NotBlank String approvalMode,
