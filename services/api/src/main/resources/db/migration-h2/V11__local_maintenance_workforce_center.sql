create table if not exists maintenance_equipment_assets (
  ...
  required_certificate varchar(120),
  notes varchar(500),
...
create table if not exists maintenance_plans (
  ...
  tenant_id varchar(64) not null default 'default',
  code varchar(64) not null,
  asset_id uuid not null references maintenance_equipment_assets(id),
  contract_id uuid references crm_service_contracts(id),
...
alter table work_orders add column if not exists check_in_at timestamp;
...
create index if not exists idx_work_order_equipment on work_orders (equipment_id, created_at);
...
('00000000-0000-4000-8000-000000002801', 'default', 'maintenance:view', '运维中心查看', 'maintenance', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002802', 'default', 'maintenance:equipment:view', '设备台账查看', 'maintenance', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002803', 'default', 'maintenance:equipment:create', '设备台账新增', 'maintenance', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002804', 'default', 'maintenance:plan:view', '维保计划查看', 'maintenance', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002805', 'default', 'maintenance:plan:create', '维保计划新增', 'maintenance', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002806', 'default', 'maintenance:plan:generate', '维保工单生成', 'maintenance', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002807', 'default', 'maintenance:workorder:view', '运维工单查看', 'maintenance', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002808', 'default', 'maintenance:workorder:create', '运维工单新增', 'maintenance', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002809', 'default', 'maintenance:workorder:assign', '运维工单派工', 'maintenance', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002810', 'default', 'maintenance:workorder:execute', '运维工单执行', 'maintenance', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002811', 'default', 'maintenance:workorder:accept', '运维工单验收', 'maintenance', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002812', 'default', 'workforce:view', '人员外勤查看', 'workforce', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002813', 'default', 'workforce:certificate:create', '人员证书新增', 'workforce', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002814', 'default', 'workforce:schedule:create', '外勤排班新增', 'workforce', current_timestamp, current_timestamp);
...
where role.tenant_id = 'default' and role.code = 'ADMIN'
  and permission.module in ('maintenance', 'workforce')
  and not exists (
