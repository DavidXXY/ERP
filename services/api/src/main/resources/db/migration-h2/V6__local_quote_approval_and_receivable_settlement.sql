...
create index if not exists idx_quote_approval_quote on crm_quote_approval_records (quote_id, decided_at);
...
create index if not exists idx_receipt_receivable on fin_receivable_receipts (receivable_id, received_date);

merge into sys_permissions (
  id, tenant_id, code, name, module, created_at, updated_at
) key (tenant_id, code) values
('00000000-0000-4000-8000-000000002311', 'default', 'crm:quote:approve', '报价审批处理', 'crm', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002312', 'default', 'crm:receivable:invoice', '应收开票登记', 'crm', current_timestamp, current_timestamp),
('00000000-0000-4000-8000-000000002313', 'default', 'crm:receivable:settle', '应收回款登记', 'crm', current_timestamp, current_timestamp);
