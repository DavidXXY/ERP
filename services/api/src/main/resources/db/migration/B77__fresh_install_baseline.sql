...
CREATE TABLE public.procurement_supplier_change_requests (
    ...
    proposed_name character varying(160),
    proposed_credit_code character varying(80),
    request_source character varying(16) DEFAULT 'INTERNAL'::character varying NOT NULL,
    reason character varying(1000) NOT NULL,
    status character varying(32) DEFAULT 'PENDING'::character varying NOT NULL,
    requested_by_name character varying(80) NOT NULL,
    reviewed_by_name character varying(80),
