...
create index if not exists idx_project_cost_project on project_cost_entries (project_id, incurred_date desc);
create index if not exists idx_project_stage_project on project_stage_records (project_id, changed_at desc);

insert into sys_permissions (
  id, tenant_id, code, name, module, created_at, updated_at
) values
('00000000-0000-4000-8000-000000002501', 'default', 'project:approve', '项目立项审批', 'project', now(), now()),
('00000000-0000-4000-8000-000000002502', 'default', 'project:stage:update', '项目阶段推进', 'project', now(), now()),
('00000000-0000-4000-8000-000000002503', 'default', 'project:cost:create', '项目成本归集', 'project', now(), now())
