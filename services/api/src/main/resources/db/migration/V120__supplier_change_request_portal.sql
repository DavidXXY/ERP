...
ALTER TABLE procurement_supplier_change_requests
  ADD COLUMN IF NOT EXISTS proposed_name VARCHAR(160),
  ADD COLUMN IF NOT EXISTS proposed_credit_code VARCHAR(80),
  ADD COLUMN IF NOT EXISTS request_source VARCHAR(16) NOT NULL DEFAULT 'INTERNAL';
