...
create index if not exists idx_voucher_date on fin_accounting_vouchers(voucher_date desc,status);
...
('00000000-0000-4000-8000-000000003001','default','finance:ledger:view','财务总账查看','finance',now(),now())
...
where role.tenant_id='default' and role.code='ADMIN' and permission.code='finance:ledger:view' on conflict do nothing;
