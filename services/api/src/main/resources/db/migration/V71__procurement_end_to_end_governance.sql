...
CREATE TABLE IF NOT EXISTS procurement_supplier_change_requests (
  ...
  proposed_admission_status VARCHAR(40),
  proposed_risk_status VARCHAR(32),
  proposed_bank_name VARCHAR(120),
  proposed_bank_account VARCHAR(512),
  proposed_settlement_terms VARCHAR(160),
...
CREATE TABLE IF NOT EXISTS procurement_supplier_reviews (
  ...
  response_score NUMERIC(5,2) NOT NULL DEFAULT 100,
  total_score NUMERIC(5,2) NOT NULL DEFAULT 0,
  grade VARCHAR(20) NOT NULL,
  reviewer_name VARCHAR(80) NOT NULL,
  improvement_action VARCHAR(1000),
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_proc_receipt_client_request
  ON procurement_goods_receipts(tenant_id, client_request_id);
CREATE UNIQUE INDEX IF NOT EXISTS uk_proc_invoice_client_request
  ON procurement_supplier_invoices(tenant_id, client_request_id);
