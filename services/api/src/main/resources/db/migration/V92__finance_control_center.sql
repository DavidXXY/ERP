...
VALUES
    ('00000000-0000-4000-8000-000000005009','default','finance:tax:view','税务台账查看','finance',now(),now(),true,0),
    ('00000000-0000-4000-8000-000000005010','default','finance:tax:manage','发票作废红冲','finance',now(),now(),true,0),
    ('00000000-0000-4000-8000-000000005011','default','finance:account:manage','会计科目与期初余额维护','finance',now(),now(),true,0)
ON CONFLICT (tenant_id, code) DO NOTHING;
