...
ALTER TABLE procurement_supplier_quotes ADD COLUMN IF NOT EXISTS submission_source VARCHAR(32) DEFAULT 'INTERNAL_ENTRY' NOT NULL;
ALTER TABLE procurement_supplier_quotes ADD COLUMN IF NOT EXISTS submission_status VARCHAR(32) DEFAULT 'SUBMITTED' NOT NULL;
ALTER TABLE procurement_supplier_quotes ADD COLUMN IF NOT EXISTS version_no INTEGER DEFAULT 1 NOT NULL;
ALTER TABLE procurement_supplier_quotes ADD COLUMN IF NOT EXISTS submitted_by_type VARCHAR(32) DEFAULT 'INTERNAL_USER' NOT NULL;
ALTER TABLE procurement_supplier_quotes ADD COLUMN IF NOT EXISTS submitted_by_id UUID;
ALTER TABLE procurement_supplier_quotes ADD COLUMN IF NOT EXISTS submitted_by_name VARCHAR(80);
ALTER TABLE procurement_supplier_quotes ADD COLUMN IF NOT EXISTS submitted_at TIMESTAMP WITH TIME ZONE;
ALTER TABLE procurement_supplier_quotes ADD COLUMN IF NOT EXISTS confirmed_by_account_id UUID;
ALTER TABLE procurement_supplier_quotes ADD COLUMN IF NOT EXISTS confirmed_at TIMESTAMP WITH TIME ZONE;
UPDATE procurement_supplier_quotes SET submitted_at = created_at WHERE submitted_at IS NULL;
