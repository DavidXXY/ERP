...
ALTER TABLE procurement_purchase_requests ADD COLUMN IF NOT EXISTS approval_level VARCHAR(24);
ALTER TABLE procurement_request_approval_records ADD COLUMN IF NOT EXISTS approval_level VARCHAR(24);
