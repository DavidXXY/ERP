...
CREATE TABLE biz_bank_statement_lines (
  ...
  counterparty varchar(180), bank_reference varchar(120) NOT NULL, summary varchar(500),
  reconciliation_status varchar(24) DEFAULT 'UNMATCHED' NOT NULL,
  matched_biz_type varchar(60), matched_biz_id uuid, matched_biz_no varchar(100),
  matched_at timestamp with time zone, matched_by varchar(80), match_note varchar(500),
  created_at timestamp with time zone DEFAULT current_timestamp NOT NULL,
  updated_at timestamp with time zone DEFAULT current_timestamp NOT NULL,
  created_by varchar(64), updated_by varchar(64), version bigint DEFAULT 0 NOT NULL,
...
CREATE TABLE biz_control_records (
  ...
  business_id uuid, business_no varchar(100), name varchar(180) NOT NULL, owner varchar(80) NOT NULL,
  status varchar(24) DEFAULT 'DRAFT' NOT NULL, risk_level varchar(16) DEFAULT 'LOW' NOT NULL,
  planned_start date, planned_end date, effective_from date, effective_to date,
  ...
  review_frequency_days integer, last_reviewed_on date, next_review_on date,
  details clob, activated_at timestamp with time zone, completed_at timestamp with time zone,
  completed_by varchar(80), completion_note varchar(1000),
  created_at timestamp with time zone DEFAULT current_timestamp NOT NULL,
  updated_at timestamp with time zone DEFAULT current_timestamp NOT NULL,
  created_by varchar(64), updated_by varchar(64), version bigint DEFAULT 0 NOT NULL,
...
CREATE TABLE biz_governance_action_logs (
  id uuid DEFAULT random_uuid() PRIMARY KEY,
  tenant_id varchar(64) DEFAULT 'default' NOT NULL,
  entity_type varchar(32) NOT NULL, entity_id uuid NOT NULL, entity_no varchar(100),
  action_type varchar(32) NOT NULL, from_status varchar(32), to_status varchar(32),
  operator_name varchar(80) NOT NULL, note varchar(1000),
  created_at timestamp with time zone DEFAULT current_timestamp NOT NULL,
  updated_at timestamp with time zone DEFAULT current_timestamp NOT NULL,
  created_by varchar(64), updated_by varchar(64), version bigint DEFAULT 0 NOT NULL
);
...
UPDATE fin_accounting_vouchers SET posted_at = COALESCE(posted_at, created_at), posted_by = COALESCE(posted_by, '系统') WHERE status = 'POSTED';
...
('00000000-0000-4000-8000-000000005001','default','governance:view','经营治理查看','governance',current_timestamp,current_timestamp,true,0),
('00000000-0000-4000-8000-000000005002','default','governance:manage','经营治理维护','governance',current_timestamp,current_timestamp,true,0),
('00000000-0000-4000-8000-000000005003','default','governance:period:close','会计期间关账','governance',current_timestamp,current_timestamp,true,0),
('00000000-0000-4000-8000-000000005004','default','governance:bank:reconcile','银行流水对账','governance',current_timestamp,current_timestamp,true,0),
('00000000-0000-4000-8000-000000005005','default','finance:voucher:create','凭证草稿新增','finance',current_timestamp,current_timestamp,true,0),
('00000000-0000-4000-8000-000000005006','default','finance:voucher:review','凭证复核','finance',current_timestamp,current_timestamp,true,0),
('00000000-0000-4000-8000-000000005007','default','finance:voucher:post','凭证记账','finance',current_timestamp,current_timestamp,true,0),
('00000000-0000-4000-8000-000000005008','default','finance:voucher:reverse','凭证冲销','finance',current_timestamp,current_timestamp,true,0);
